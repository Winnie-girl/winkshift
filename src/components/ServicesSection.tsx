      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Free AI Blueprints</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Get step-by-step video tutorials and downloadable templates to build powerful automations for your business.
            </p>
            <button className="w-full border-2 border-coral-500 text-coral-500 hover:bg-coral-500 hover:text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 flex items-center justify-center group">
              Browse Blueprints
          ...
          {/* Prompt Library */}
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Prompt Library</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          {/* AI Tools Directory */}
          <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">AI Tools Directory</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h4 className="text-2xl font-bold text-gray-900 mb-6">Custom AI Automation</h4>
            ...
            <button className="bg-coral-500 hover:bg-coral-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center group w-full justify-center">
              Build My Automation
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          ...
          {/* 1:1 Consulting */}
          <div className="bg-white rounded-3xl p-10 shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h4 className="text-2xl font-bold text-gray-900 mb-6">1:1 Consulting</h4>
            <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            <button className="bg-gray-800 hover:bg-gray-900 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center group w-full justify-center">
              Book a Session
              <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
