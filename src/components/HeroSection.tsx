        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          ...
          <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'animate-slide-in-left' : 'opacity-0'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 transition-all duration-1000 delay-1100 ${isVisible ? 'animate-fade-in-up' : 'opacity-0 translate-y-10'}`}>
              ...
              <button className="border-2 border-gray-600 hover:border-gray-400 text-gray-300 hover:text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 hover:bg-gray-800/50 hover:scale-105 hover:shadow-lg">
                View My Services
              </button>
            </div>
          </div>
          ...
          <div className={`lg:pl-12 transition-all duration-1000 delay-600 ${isVisible ? 'animate-slide-in-right' : 'opacity-0'}`}>
            <div className="relative">
              <div className="aspect-square max-w-md mx-auto bg-gradient-to-br from-gray-800/30 to-purple-800/30 rounded-3xl shadow-2xl border border-gray-700/30 flex items-center justify-center hover:scale-105 transition-transform duration-500">
              ...
              {/* Floating elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-cyan-500/30 rounded-full opacity-70"></div>
              <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-purple-500/30 rounded-full opacity-60"></div>
            </div>
          </div>
        </div>
      </div>
