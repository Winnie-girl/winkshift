      ...
      <div className="max-w-4xl mx-auto text-center">
        <div ref={ref} className={`bg-gradient-to-r from-gray-800 to-gray-900 rounded-3xl p-16 text-white relative overflow-hidden hover:scale-105 transition-all duration-700 ${isVisible ? 'animate-scale-in' : 'opacity-0'}`}>
          ...
          <div className="relative z-10">
            ...
            <button className={`bg-coral-500 hover:bg-coral-600 text-white px-10 py-5 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-coral-500/25 flex items-center mx-auto group animate-glow ${isVisible ? 'animate-fade-in-up' : 'opacity-0'} delay-700`}>
              Get Started Today
