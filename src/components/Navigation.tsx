      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              >
                ...
                <div className={`absolute top-full left-0 mt-1 w-48 bg-white/95 backdrop-blur-md rounded-md shadow-lg border border-deep-purple-200/30 transition-all duration-200 ${isResourcesOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                  <div className="py-1">
                    <Link 
                      to="/prompts" 
        ...
        <div className={`md:hidden transition-all duration-300 overflow-hidden ${isMenuOpen ? 'max-h-80 opacity-100' : 'max-h-0 opacity-0'}`}>
          <div className="px-2 pt-2 pb-3 space-y-1 bg-midnight-800/95 backdrop-blur-md rounded-lg mt-2 shadow-lg border border-deep-purple-600/30">
            ...
            <a href="#" onClick={() => setIsMenuOpen(false)} className="block w-full text-left px-3 py-2 text-gray-300 hover:text-white text-base font-medium transition-all duration-300 hover:bg-deep-purple-700/50 rounded-lg hover:scale-105">
              AI Blueprints
            </a>
